"""Модуль генерации и тренирвки персонажа."""
...
def attack(char_name: str, char_class: str) -> str:
    """Функция расчета атаки персонажа."""
    ...
    if char_class == 'healer':
        return (f'{char_name} нанёс урон противнику равный '
                '{5 + randint(-3, -1)}')
    return (f'{char_class} не умеет атаковать')


def defence(char_name: str, char_class: str) -> str:
    """Функция расчета защиты персонажа."""
    if char_class == 'warrior':
    ...
    return (f'{char_class} не умеет защищаться')


def special(char_name: str, char_class: str) -> str:
    """Функция расчета спец уменя персонажа."""
    if char_class == 'warrior':
    ...
    return (f'{char_class} не имеет суперсилы')


def start_training(char_name: str, char_class: str) -> str:
    """Функция тренировки игрока по управлению."""
    if char_class == 'warrior':
